...
const providerData = [
  ...
  { name: "Investec Corporate Cash Management", bookPercent: "3.8 %", value: "R 139,656,065" },
];
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {aumByProductData.map((entry, index) => (
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-muted-foreground text-xs">
                      ...
                      <th className="text-right pb-2 font-normal">Next birthday</th>
